...
public class Info_2 extends AppCompatActivity {
    ...
    private TextView ChangeThePassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav1.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    case R.id.home:
                        Intent i =new Intent(Info_2.this, Qoy_9.class);
                        startActivity(i);
                        break;
                    case R.id.myinfo:
                        Intent b = new Intent(Info_2.this,Info_2.class);
                        startActivity(b);
                        break;
                    case R.id.message:
                        Intent c = new Intent(Info_2.this, Message_1_2.class);
                        startActivity(c);
                        break;
                    case R.id.customer:
                        Intent d = new Intent(Info_2.this, Search_2.class);
                        startActivity(d);
                        break;
                    case R.id.rel1:
                        Intent e = new Intent(Info_2.this, Request.class);
                        startActivity(e);
                        break;
                }
                return true;
        ...
        ChangeThePassword = (TextView)findViewById(R.id.changepassword);
        ...
        ChangeThePassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i =new Intent(Info_2.this, ChangePass2.class);
                startActivity(i);
            }
        });
        LogOut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final ProgressDialog csprogress=new ProgressDialog( Info_2.this);
...
//whatever you want just you have to launch overhere.
                        FirebaseAuth auth = FirebaseAuth.getInstance();
                        auth.signOut();
                        Intent i =new Intent(Info_2.this, Activity_2.class);
                        startActivity(i);
                        finish();
                    }
                }, 13000);
            ...
            ref.putFile(filePath)
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Toast.makeText(Info_2.this, "Yuklendi", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(Info_2.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    private void EmailChange(){
        Intent i =new Intent(Info_2.this, ChangeEmail2.class);
        startActivity(i);
    }
    private void PhoneChange(){
        Intent i =new Intent(Info_2.this, PhoneChange.class);
        startActivity(i);
    }
    private void ContactChange(){
        Intent i =new Intent(Info_2.this, Home.class);
        startActivity(i);
    }
    private void ScoreShow(){
        Intent i = new Intent(Info_2.this, ScoreShow.class);
        startActivity(i);
    }
